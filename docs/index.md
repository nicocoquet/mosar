...
- à partir de cette enquête, sélectionner un panel de 20 revues à accompagner sur la durée : créer un parcours d’accompagnement qui concilie suivi individualisé et accompagnement vers les standards de l’accès ouvert diamant (DOAS) ;
...
- un rapport dressant l’état des lieux du paysage éditorial à Paris 1 et Paris Nanterre ;
- une offre de services complète destinée aux 186 revues du périmètre (formations, ressources, etc.), accompagnée d’indicateurs quantitatifs et qualitatifs (nombre de revues accompagnées, résultats obtenus, trajectoires d’évolution) ;
